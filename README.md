...
```bash
git clone --recursive https://github.com/Celine-audio/GALLERY.git
```
...
GALLERY being free open-source software using the [JUCE](https://juce.com)
framework, and using its free licence, it inherits its AGPLv3 terms. GALLERY is then
...
Using GALLERY costs nothing and obliges nothing. The licence governs the distribution
...
### AI disclosure
GALLERY contains no AI whatsoever. However, AI assistants were used alongside the authors during development; GALLERY remains the authors' work.