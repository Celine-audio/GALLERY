...
void AboutPanel::paint (juce::Graphics& g)
{
    ...
    // Baseline-centred, exactly as the toolbar draws it. "gallery" has two descenders,
    // and a mark centred on its bounding box instead sits visibly high against the
    // house logo beside it.
